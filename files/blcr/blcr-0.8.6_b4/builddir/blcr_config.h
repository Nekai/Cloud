...
#define BLCR_CONFIG_TIMESTAMP "Mon Nov 13 00:16:14 EST 2017"
...
#define CR_EXPORTED_KCODE___register_chrdev 0xffffffff811cb270

/* Define to address of exported kernel symbol register_blkdev */
#define CR_EXPORTED_KCODE_register_blkdev 0xffffffff812bb5f0
...
/* Define to address of non-exported kernel symbol __audit_syscall_exit, or 0
   if exported */
#define CR_KCODE___audit_syscall_exit 0xffffffff810fabe0
...
/* Define to address of non-exported kernel symbol change_pid, or 0 if
   exported */
#define CR_KCODE_change_pid 0xffffffff81093850

/* Define to address of non-exported kernel symbol
   compat_arch_setup_additional_pages, or 0 if exported */
/* #undef CR_KCODE_compat_arch_setup_additional_pages */

/* Define to address of non-exported kernel symbol copy_fs_struct, or 0 if
   exported */
#define CR_KCODE_copy_fs_struct 0xffffffff811f7ed0

/* Define to address of non-exported kernel symbol copy_siginfo_to_user, or 0
   if exported */
#define CR_KCODE_copy_siginfo_to_user 0xffffffff81085c20

/* Define to address of non-exported kernel symbol detach_pid, or 0 if
   exported */
#define CR_KCODE_detach_pid 0xffffffff81093830
...
/* Define to address of non-exported kernel symbol do_mmap_pgoff, or 0 if
   exported */
#define CR_KCODE_do_mmap_pgoff 0xffffffff811897a0

/* Define to address of non-exported kernel symbol do_munmap, or 0 if exported
   */
#define CR_KCODE_do_munmap 0xffffffff81188800
...
/* Define to address of non-exported kernel symbol do_pipe_flags, or 0 if
   exported */
#define CR_KCODE_do_pipe_flags 0xffffffff811d04e0

/* Define to address of non-exported kernel symbol do_sigaction, or 0 if
   exported */
#define CR_KCODE_do_sigaction 0xffffffff81086340

/* Define to address of non-exported kernel symbol do_sigaltstack, or 0 if
   exported */
#define CR_KCODE_do_sigaltstack 0xffffffff81081950

/* Define to address of non-exported kernel symbol expand_fdtable, or 0 if
   exported */
#define CR_KCODE_expand_fdtable 0xffffffff811e43d0
...
/* Define to address of non-exported kernel symbol find_task_by_pid_ns, or 0
   if exported */
#define CR_KCODE_find_task_by_pid_ns 0xffffffff81093900

/* Define to address of non-exported kernel symbol flush_icache_range, or 0 if
   exported */
/* #undef CR_KCODE_flush_icache_range */

/* Define to address of non-exported kernel symbol follow_huge_addr, or 0 if
   exported */
#define CR_KCODE_follow_huge_addr 0xffffffff810606d0

/* Define to address of non-exported kernel symbol follow_huge_pmd, or 0 if
   exported */
#define CR_KCODE_follow_huge_pmd 0xffffffff81060730

/* Define to address of non-exported kernel symbol free_fs_struct, or 0 if
   exported */
#define CR_KCODE_free_fs_struct 0xffffffff811f7e00

/* Define to address of non-exported kernel symbol free_pid, or 0 if exported
   */
#define CR_KCODE_free_pid 0xffffffff810930e0

/* Define to address of non-exported kernel symbol get_dumpable, or 0 if
   exported */
#define CR_KCODE_get_dumpable 0xffffffff811cea80

/* Define to address of non-exported kernel symbol group_send_sig_info, or 0
   if exported */
#define CR_KCODE_group_send_sig_info 0xffffffff810843b0

/* Define to address of non-exported kernel symbol groups_search, or 0 if
   exported */
#define CR_KCODE_groups_search 0xffffffff8109f520
...
/* Define to address of non-exported kernel symbol init_fpu, or 0 if exported
   */
#define CR_KCODE_init_fpu 0

/* Define to address of non-exported kernel symbol is_file_shm_hugepages, or 0
   if exported */
#define CR_KCODE_is_file_shm_hugepages 0xffffffff81257f60
...
/* Define to address of non-exported kernel symbol pipe_fcntl, or 0 if
   exported */
#define CR_KCODE_pipe_fcntl 0xffffffff811d06b0

/* Define to address of non-exported kernel symbol pmd_huge, or 0 if exported
   */
#define CR_KCODE_pmd_huge 0xffffffff810606f0
...
/* Define to address of non-exported kernel symbol set_dumpable, or 0 if
   exported */
#define CR_KCODE_set_dumpable 0xffffffff811ce850

/* Define to address of non-exported kernel symbol set_fs_pwd, or 0 if
   exported */
#define CR_KCODE_set_fs_pwd 0xffffffff811f7b70

/* Define to address of non-exported kernel symbol set_mm_exe_file, or 0 if
   exported */
#define CR_KCODE_set_mm_exe_file 0xffffffff8106b3e0
...
/* Define to address of non-exported kernel symbol signal_wake_up_state, or 0
   if exported */
#define CR_KCODE_signal_wake_up_state 0xffffffff81082900
...
/* Define to address of non-exported kernel symbol sys_setitimer, or 0 if
   exported */
#define CR_KCODE_sys_setitimer 0xffffffff81075b00
...
/* Define to address of non-exported kernel symbol sys_unlink, or 0 if
   exported */
#define CR_KCODE_sys_unlink 0xffffffff811d8530

/* Define to address of non-exported kernel symbol syscall32_setup_pages, or 0
   if exported */
#define CR_KCODE_syscall32_setup_pages 0xffffffff81062640
...
/* Define to address of non-exported kernel symbol anon_pipe_buf_ops, or 0 if
   exported */
#define CR_KDATA_anon_pipe_buf_ops 0xffffffff8164c340
...
/* Define to address of non-exported kernel symbol hugetlbfs_file_operations,
   or 0 if exported */
#define CR_KDATA_hugetlbfs_file_operations 0xffffffff81657100
...
/* Define to address of non-exported kernel symbol old_rsp, or 0 if exported
   */
#define CR_KDATA_old_rsp 0x000000000000af80
...
/* Define to address of non-exported kernel symbol pid_hash, or 0 if exported
   */
#define CR_KDATA_pid_hash 0xffffffff81d61cf8

/* Define to address of non-exported kernel symbol pidhash_shift, or 0 if
   exported */
#define CR_KDATA_pidhash_shift 0xffffffff81941a90
...
/* Define to address of non-exported kernel symbol pidmap_lock, or 0 if
   exported */
#define CR_KDATA_pidmap_lock 0xffffffff81903140
...
/* Define to 1 if the kernel has 2-arg vfs_getattr(). */
...
/* Define to 1 if the kernel has 3-arg vfs_getattr(). */
...
/* Define to 1 if the kernel has 6-arg do_mmap_pgoff(). */
#define HAVE_6_ARG_DO_MMAP_PGOFF 0

/* Define to 1 if the kernel has 7-arg do_mmap_pgoff(). */
...
/* Define to 1 if the kernel type 'struct file' has member 'f_path' of type
   'struct path'. */
...
/* Define to 1 if the kernel type 'mm_context_t' has member 'sigpage' of type
   'unsigned long'. */
/* #undef HAVE_MM_CONTEXT_SIGPAGE */
...
/* Define to 1 if the kernel type 'struct mm_struct' has member
   'free_area_cache' of type 'unsigned long'. */
...
/* Define to 1 if the kernel type 'struct pid_namespace' has member
   'nr_hashed' of type 'unsigned int'. */
...
/* Define to 1 if the kernel type 'struct thread_struct' has member 'fpr' of
   type 'void*'. */
/* #undef HAVE_THREAD_FPR */

/* Define to 1 if the kernel type 'struct thread_struct' has member 'fpu' of
   type 'struct fpu'. */
#define HAVE_THREAD_FPU 1

/* Define to 1 if the kernel type 'struct thread_struct' has member 'fp_state'
   of type 'struct thread_fp_state'. */
/* #undef HAVE_THREAD_FP_STATE */
...
/* #undef HAVE_THREAD_INFO_TP_VALUE_ARRAY */
...
/* Define to 1 if the kernel type 'struct thread_struct' has member 'vr' of
   type 'void*'. */
/* #undef HAVE_THREAD_VR */

/* Define to 1 if the kernel type 'struct thread_struct' has member 'vr_state'
   of type 'struct thread_vr_state'. */
/* #undef HAVE_THREAD_VR_STATE */
...
#define PACKAGE_STRING "blcr 0.8.6_b4"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "blcr"

/* Define to the version of this package. */
#define PACKAGE_VERSION "0.8.6_b4"
