...
#SUBDIR = vmadump4
#TARGET = vmadump
#SOURCES = vmadump_common.c vmadump_x86_64.c optional.h
...
SHELL := /bin/sh
INSTALL_data := /bin/install -c -c -m 644
top_srcdir := /home/sharp67/cloud/files/blcr/blcr-0.8.6_b4
top_builddir := /home/sharp67/cloud/files/blcr/blcr-0.8.6_b4/builddir
prefix := /usr/local
exec_prefix := ${prefix}
installdir := $(DESTDIR)${exec_prefix}/lib/blcr/3.10.0-229.20.1.el7.x86_64
LINUX := /lib/modules/3.10.0-229.20.1.el7.x86_64/build
LINUX_OBJ := /lib/modules/3.10.0-229.20.1.el7.x86_64/build
...
all: $(LINUX_OBJ)/.config prepare
	$(MAKE) -C $(LINUX) KBUILD_EXTMOD=$(builddir) CC="gcc"
clean:
