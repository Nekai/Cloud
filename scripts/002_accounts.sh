...
# HHS
useradd -u 1010 -g users -c "Chuck Schwarz" -p '$6$Db6M1nOH3bdT3fbu$GGbeO0eYSS7p6xMf21lIsjtqwD1pMzqxmyFVdtzJo6mQtpd5FrQ8FhyXDl24y46iNHKvNOcnvKcJL8oCQz352.' chuck
useradd -u 1011 -g users -c "Lev Gorenstein"   -p '$6$3.fHvkWXMVqm7JzP$20kNcI7cZHLaQu8/waPbo9NqiI3iAqiXtD4m.Za6/13Jogd7lmWr8GuNaCiljZNtx199ZI1q4dJzYwlVeIFqq0' lev
...
useradd -u 1014 -g users -c "Jacob Sharp"      -p '$6$p06BdgV7zkYyhRMW$tPxLJgZk3mSn5WaVdxCYlgvUc3iDNlowkfnZxRcoP.mz76uJVWgfaf7Jl8L650OrJ4E/EjLgQlAjK6/FcAzEI0'  sharp67
useradd -u 1015 -g users -c "Callum Gundlach"  -p '$6$v2WfT1wDJj7.4hIt$X56n82OH0QEKOW76xthGRjE8Qw/h/NMDDCg3eUR5LAhcfe.TwHC4fuXa00BYKlMPJ1TQ1zPjkMQyIjykZ4R2z1'  cgundlach
...
useradd -u 1017 -g users -c "Patrick Finnegan" -p '$6$0OJ49TG3$bHcpsVTQVgEKW1q7ORv5IR1xrhNTtSHqvJjg9lFHsYdhHngyRA.m5iUgUYFLHKpNvr2De2jFF/2LARJFAArTc/' finnegpt
